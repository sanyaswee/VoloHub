...
function ProjectCard({ project, onEdit, onLoginRequired, onVoteChange, score, showScore, hasApplied }: ProjectCardProps) {
  ...
  return (
    <article className="project-card" onClick={handleCardClick}>
      {hasApplied && (
        <div className="applied-badge" aria-label="You have applied to this project">
